...
import {
  LayoutDashboard, Calendar, Users, PhoneCall, Settings, LogOut, Hospital, ChevronRight, PanelLeftClose,
} from 'lucide-react';
    ...
    <aside className="w-64 min-h-screen bg-gradient-to-b from-medical-900 to-medical-950 flex flex-col shadow-sidebar flex-shrink-0">
      ...
      <div className="px-4 py-5 border-b border-white/10 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-display font-bold text-white text-lg leading-tight">MedCare</p>
            <p className="text-medical-300 text-xs font-medium tracking-wide">CRM SYSTEM</p>
          </div>
        </div>
        <button onClick={onCollapse} className="p-1.5 hover:bg-white/10 rounded-lg transition-colors flex-shrink-0" title="Close menu">
